...
(function ( util, model, debug, lang, item, clipboard, widgetUtil, $ ) {
    ...
    $.widget( "apex.grid", $.apex.tableModelViewBase, $.extend( true,
        ...
        _calculateColumnWidths: function( col$, finalSet, resetWidths ) {
            ...
            if ( finalSet ) {
                // Was using clientWidth as follows but IE11 returned 0 perhaps because of inline-block. See bug 29530019
        ...
        _afterInsert: function( insertedElements, copy ) {
            var i, col, controlBreakData, rownum, record, values,
                self = this,
            ...
            if ( this._hasControlBreaks() && !copy && insertedElements[0] ) {
                ...
                if ( rownum != null ) { // != on purpose to catch null or undefined
                    ...
                    record = this.model.getRecord( insertedElements[0].attr( "data-id" ) );
            ...
            setTimeout( function() {
                // select and edit
                self._select( cell$,  null, focus, false, false );
                if ( focus && self.options.editable && !self.editMode ) {
        ...
        _expandCollapseControlBreak: function( pRows, expand ) {
            var i, row$, otherTableChildren$, title, saveFocusInHeader,
                unselect = [],

...
widget.textarea = function( pId, pOptions ) {
    ...
    function charCount() {
        ...
        var lLength  = gTextarea.val().replace(/\n/g, "xx").length,
            ...
            TEXT_COUNTER_CLASS = "apex-item-textarea-counter",
            TEXTAREA_CLASS = "apex-item-textarea";
        ...
        if ( lLength >= gOptions.maxChar ) {
            ...
            gTextarea.attr( "class", TEXTAREA_CLASS + " has-error" );
            gCounter.html( gOptions.maxChar );
        } else {
            gTextarea.attr( "class", TEXTAREA_CLASS );
        ...
        if ( lPctFull > 95 ) {
            gCountDiv.attr( "class", TEXT_COUNTER_CLASS + " apex-item-textarea-counter--error" );
        } else if ( lPctFull >= 90 ) {
            gCountDiv.attr( "class", TEXT_COUNTER_CLASS + " apex-item-textarea-counter--warning" );
        } else {
            gCountDiv.attr( "class", TEXT_COUNTER_CLASS );
        }
    } // charCount
